<template>
  <div id="app">
    <!--speech-box :headerText="A.header" :footerText="A.footer" props로 넘긴값 명시-->
    <speech-box :headerText="A.header" :footerText="A.footer">
      <div>
        <p>
          <!--메세지는 slot으로 넘겼으므로 표기법을 이용해 바로 불러올 수 있음 -->
          {{A.message}}
        </p>
      </div>
    </speech-box>
    <!--speech-box로 명시 == 자식 컴포넌트의 slot으로 전달-->
...
<style scoped>
  .sanders { background-color: #faebd7; }
